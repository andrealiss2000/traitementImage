...
public class Appli {
	...
	public static void main(String[] args) {
		...
		//Test filtre médian 
		Image couleur = TraitementImagesUtils.readImage("E:/Licence IOT/PERIODE E/Programmation Avancée/workspace/traitementImage/traitementImageProject/database/maldive.jpg");
