...
public class Appli {
	...
	public static void main(String[] args) {
		...
		//Test filtre médian 
		Image couleur = TraitementImagesUtils.readImage("C:\\Users\\d_vig\\Downloads\\kurtz_image\\eiffel.jpg");
		...
		if(result.getBDim() == 3){
			...
			//Map<Double, String> similarHSV = TraitementImagesUtils.getSimilarImagesHSV(result);
